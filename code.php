    ...
    public function checkConnection()
    {
      //  $host = '91.227.244.57'; // Update with the desired host
       ...
       // $url = 'https://nabiltest.compassplus.com' . $port;
        ...
        // $certificate_file = //path of certificate file
        // curl_setopt($ch, CURLOPT_SSLCERT, $certificate_file);
...
$cert_file = storage_path('app/ssl/memtestican.org.np.crt.txt');

      
$key_file = storage_path('app/ssl/memtestican.org.np.key.txt');
        // $curl = curl_init();
		...
		<Merchant>NABIL106698</Merchant>  -- your merchant id
		<Amount>100</Amount> -- for Rs 1, you need to pass 100
		<Currency>524</Currency>  -- 524 for NPR
		<Description>123XXXX</Description> -- this is the unique id from your system
		<ApproveURL></ApproveURL> -- URL to redirect if transaction is approved
		<CancelURL></CancelURL> --URL to redirect if transaction is Cancelled
		<DeclineURL></DeclineURL> --URL to redirect if transaction is Declined
		<Fee>0</Fee>
		</Order>
		</Request>
		</TKKPG>';
...
//curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, false);  /for disabling curl certificate issue
//curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);  // disabling curl certificate issue
